...
const escapeStringRegexp = __webpack_require__(5898);
...
let tty = __webpack_require__(6224)
...
var _picocolors = _interopRequireWildcard(__webpack_require__(7023), true);
...
}
{
  ...
  exports.getChalk = ({
    ...
    var _chalk;
    (_chalk = chalk) != null ? _chalk : chalk = __webpack_require__(7658);
    if (forceColor) {
...
__webpack_require__.d(__webpack_exports__, {
  "parsePackage": () => (/* binding */ parsePackage),
  "readPackage": () => (/* binding */ readPackage),
  "readPackageSync": () => (/* binding */ readPackageSync)
});
...
// EXTERNAL MODULE: ./node_modules/read-pkg/node_modules/json-parse-even-better-errors/lib/index.js
var lib = __webpack_require__(7509);
// EXTERNAL MODULE: ./node_modules/@babel/code-frame/lib/index.js
var code_frame_lib = __webpack_require__(1322);
;// CONCATENATED MODULE: ./node_modules/read-pkg/node_modules/lines-and-columns/build/index.mjs
var LF = '\n';
var CR = '\r';
...
;// CONCATENATED MODULE: ./node_modules/read-pkg/node_modules/parse-json/index.js
...
const generateCodeFrame = (string, location, highlightCode = true) =>
	(0,code_frame_lib/* codeFrameColumns */.rf)(string, {start: location}, {highlightCode});
...
const getPackagePath = cwd => external_node_path_.resolve(toPath(cwd) ?? '.', 'package.json');
...
async function readPackage({cwd, normalize = true} = {}) {
	const packageFile = await promises_.readFile(getPackagePath(cwd), 'utf8');
	return _readPackage(packageFile, normalize);
}

function readPackageSync({cwd, normalize = true} = {}) {
	const packageFile = external_node_fs_.readFileSync(getPackagePath(cwd), 'utf8');
	return _readPackage(packageFile, normalize);
}
